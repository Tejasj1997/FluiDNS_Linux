...
def RK1(bod,ischeme,poi_b,ene,buo,bcxu,bcxv,bcyu,bcyv,bcxt,bcyt,ny,nx,dy,dx,rho,nu,Ri,Pr,dt,u,v,p,T,vel,t,A0,omp,eps,eps_in,T0):
    #################### RK1 ### Time Integrator #############################################
    ...
    # boundary conditions
    u,v = bc.boundary_conditions(bcxu,bcxv,bcyu,bcyv,dy,dx,dt,u,un,v,vn,vel,t,A0,omp)
    # pressure poisson
...
def CPM(bod,ischeme,poi_b,ene,buo,bcxu,bcxv,bcyu,bcyv,bcxt,bcyt,ny,nx,dy,dx,rho,nu,Ri,Pr,dt,u,v,p,T,vel,t,A0,omp,eps,eps_in,T0):
    ...
    # boundary conditions
    u_sp,v_sp = bc.boundary_conditions(bcxu,bcxv,bcyu,bcyv,dy,dx,dt,u_sp,un,v_sp,vn,vel,t,A0,omp)
    # pressure poisson
...
def AB2(bod,ischeme,poi_b,ene,buo,bcxu,bcxv,bcyu,bcyv,bcxt,bcyt,ny,nx,dy,dx,rho,nu,Ri,Pr,dt,u,un,v,vn,p,pn,T,Tn,vel,t,A0,omp,eps,eps_in,T0):
