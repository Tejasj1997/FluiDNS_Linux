...
#             self.T = np.zeros([ny,nx])
    ...
    def solver(self,nt_st,nt_en):
        ...
        for i in range(nt):
            ...
            if self.ischeme == 'RK1':
                self.u,self.v,self.p,self.T = TIM.RK1(self.bod,self.ischeme,self.poi_b,self.ene,self.buo,self.bcxu,self.bcxv,self.bcyu,self.bcyv,self.bcxt,self.bcyt,                 self.L,self.H,self.ny,self.nx,self.dy,self.dx,self.rho,self.nu,self.Ri,self.Pr,self.dt,self.u,self.v,self.p,self.T,self.vel,t,self.A0,self.omp,eps,eps_in,self.T0)
                ...
                if i == 0:
                    un,vn,pn,Tn = TIM.RK1(self.bod,self.ischeme,self.poi_b,self.ene,self.buo,self.bcxu,self.bcxv,self.bcyu,self.bcyv,self.bcxt,self.bcyt,                                                self.L,self.H,self.ny,self.nx,self.dy,self.dx,self.rho,self.nu,self.Ri,self.Pr,self.dt                                                ,self.u,self.v,self.p,self.T,self.vel,t,self.A0,self.omp                                               ,eps,eps_in,self.T0)
                    
                else:
                    self.u,self.v,self.p,self.T,un,vn,pn,Tn = TIM.AB2(self.bod,self.ischeme,self.poi_b,self.ene,self.buo,self.bcxu,self.bcxv,self.bcyu,self.bcyv,self.bcxt,self.bcyt,                                                self.L,self.H,self.ny,self.nx,self.dy,self.dx,self.rho,self.nu,self.Ri,self.Pr,self.dt                                                ,self.u,un,self.v,vn,self.p,pn,self.T,Tn,self.vel,t,self.A0,self.omp                                               ,eps,eps_in,self.T0)
            ...
            if self.ene == 'on':
                pro_T = np.append(pro_T,self.T[int(self.ny/2),int(self.nx/2)])
