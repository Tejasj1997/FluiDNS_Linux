...
def VIV(ypos,yvel,cl,mstar,zeta,omstar,st,theta,dt):
    yddot = (1/mstar) * ((cl/2) - 2*mstar*zeta*omstar*st*yvel - mstar * ypos * (omstar*st)**2 )
    ydot = yvel + dt*yddot
    y = ypos + (dt) * ((1-theta)*yvel + theta * ydot)
